  ...
  en: {
    translation: {
      ...
      onboardingAi: {
        ...
        titleWithName: "Setup",
        subtitle: "Setup",
        existingData: "Existing profile",
        prefillRole: "Target role",
        prefillExperience: "Experience level",
        prefillSkills: "Current skills",
        prefillGoalRole: "Target role",
        prefillFocus: "Focus",
        steps: {
          provider: "AI provider",
          narrative: "Your context",
          review: "Review"
        },
        provider: {
          title: "OpenRouter",
          ...
          modelCopy:
            "Found {{textCount}} text models and {{embeddingCount}} embedding models. Pick what Leetgrind should use by default.",
          textModel: "Text model",
          embeddingModel: "Embedding model",
          savedModels: "Saved models",
          savedKey: "Saved key is available. Paste a new key only if you want to replace it.",
          change: "Change provider",
          current: "Current provider",
          statusMissing: "OpenRouter is not connected yet.",
          statusReady: "OpenRouter is ready. Text model: {{model}}.",
          discoveryFailed: "Could not load OpenRouter models.",
          pickTextModel: "Choose a text model before continuing.",
          testFailed: "Could not verify the OpenRouter connection."
        },
        narrative: {
          title: "Profile and goal",
          experience: "Experience, skills, and weak spots",
          experiencePlaceholder:
            "Example: I am a frontend developer with React and TypeScript experience. I know hooks and state management, but algorithms, browser internals, and system design are weak...",
          goal: "Preparation goal",
          goalPlaceholder:
            "Example: prepare for senior frontend interviews at product companies in the next three months.",
          resume: "Resume or background notes",
          resumePlaceholder: "Optional. Paste resume text, project history, or anything that should shape the plan.",
          extract: "Build my map"
        },
        review: {
          title: "Review the extracted map",
          profile: "Profile",
          preferences: "Preferences",
          goals: "Goals",
          skills: "Skills",
          assumptions: "Assumptions",
          firstActions: "Suggested first actions",
          back: "Edit text",
          save: "Save and open workspace"
        }
      },
      onboarding: {
  ...
  ru: {
    translation: {
      ...
      onboardingAi: {
        kicker: "Настройка",
        title: "Настройка",
        titleWithName: "Настройка",
        subtitle: "Настройка",
        existingData: "Профиль уже есть",
        prefillRole: "Целевая роль",
        prefillExperience: "Уровень опыта",
        prefillSkills: "Текущие навыки",
        prefillGoalRole: "Целевая роль",
        prefillFocus: "Фокус",
        steps: {
          provider: "AI-провайдер",
          narrative: "Твой контекст",
          review: "Проверка"
        },
        provider: {
          title: "OpenRouter",
          ...
          apiKeyPlaceholder: "sk-or-...",
          connect: "Найти модели",
          loadModels: "Загрузить модели",
          reloadModels: "Обновить модели",
          saveAndContinue: "Сохранить и продолжить",
          modelTitle: "Выбери модели",
          modelCopy:
            "Найдено text-моделей: {{textCount}}, embedding-моделей: {{embeddingCount}}. Выбери, что Leetgrind будет использовать по умолчанию.",
          textModel: "Текстовая модель",
          embeddingModel: "Embedding-модель",
          savedModels: "Сохраненные модели",
          savedKey: "Сохраненный ключ доступен. Вставь новый ключ только если хочешь заменить его.",
          change: "Сменить провайдера",
          current: "Текущий провайдер",
          statusMissing: "OpenRouter пока не подключен.",
          statusReady: "OpenRouter готов. Текстовая модель: {{model}}.",
          discoveryFailed: "Не удалось загрузить модели OpenRouter.",
          pickTextModel: "Выбери текстовую модель перед продолжением.",
          testFailed: "Не удалось проверить подключение OpenRouter."
        },
        narrative: {
          title: "Профиль и цель",
          experience: "Опыт, навыки и слабые места",
          experiencePlaceholder:
            "Например: я frontend-разработчик, работал с React и TypeScript. Нормально знаю hooks и state management, но алгоритмы, браузерные внутренности и system design слабые...",
          goal: "Цель подготовки",
          goalPlaceholder:
            "Например: подготовиться к senior frontend собеседованиям в продуктовые компании за три месяца.",
          resume: "Резюме или заметки о бэкграунде",
          resumePlaceholder: "Необязательно. Вставь резюме, историю проектов или любой контекст для плана.",
          extract: "Собрать карту"
        },
        review: {
          title: "Проверь извлеченную карту",
          profile: "Профиль",
          preferences: "Предпочтения",
          goals: "Цели",
          skills: "Навыки",
          assumptions: "Допущения",
          firstActions: "Первые действия",
          back: "Изменить текст",
          save: "Сохранить и открыть рабочее пространство"
        }
      },
      onboarding: {
